...
export default class PropertyDetails extends Component{
    constructor(props){
        ...
        this.state = {
            ...
            dwelling_coverage: '35',
            detatched_structures: '45',
            personal_property: '55',
            additional_living_expense: '150',
            medical_expense: '400',
            deductable: '30',
        }
    }
    ...
    onSubmit(e){
        ...
        axios.post('http://localhost:4200/property/add', [getquote, homeownerinfo, propertydetails, coveragedetails, {token: localStorage.getItem('access_token')}]).then(res => {
